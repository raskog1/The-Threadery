...
import { Button, Card, CardContent, Slide, Snackbar, TextField } from "@material-ui/core";
...
function Login() {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // If data is successful, set token in local storage
                ...
                <CardContent>
                    <form noValidate autoComplete="on" onSubmit={(e) => onSubmit(e)}>
                        ...
                        <Button color="secondary" size="medium" variant={type.signup ? "contained" : "text"}
                            onClick={(e) => type.signup ? onSubmit(e) : setType({ login: !type.login, signup: !type.signup })}
                            style={{ float: "left" }}>
                            Sign Up
                    </Button>
